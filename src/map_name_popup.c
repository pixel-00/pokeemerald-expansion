...
{
    [MAPSEC_TINYBUD_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GREENGLADE_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_NEWHOPE_CITY] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_LUSH_CLEARING] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_TINYBUD_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GREENGLADE_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_NEWHOPE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_LUSH_CLEARING] = MAPPOPUP_THEME_BW_DEFAULT,
