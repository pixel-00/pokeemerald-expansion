...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_VISITED_TINYBUD_TOWN) &&
                FlagGet(FLAG_VISITED_GREENGLADE_TOWN) &&
                ...
                FlagGet(FLAG_VISITED_NEWHOPE_CITY) &&
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    ...
    {
        PlaySE(SE_PC_OFF);
        FlagClear(FLAG_VISITED_TINYBUD_TOWN);
        FlagClear(FLAG_VISITED_GREENGLADE_TOWN);
        ...
        FlagClear(FLAG_VISITED_NEWHOPE_CITY);
    ...
    {
        PlaySE(SE_PC_LOGIN);
        FlagSet(FLAG_VISITED_TINYBUD_TOWN);
        FlagSet(FLAG_VISITED_GREENGLADE_TOWN);
        ...
        FlagSet(FLAG_VISITED_NEWHOPE_CITY);
