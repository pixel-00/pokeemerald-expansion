...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_GREENGLADE_TOWN_POKEMON_CENTER_1F,
        ...
        MAP_NEWHOPE_CITY_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(GREENGLADE_TOWN_MART),     MAP_NUM(GREENGLADE_TOWN_MART),     LOCALID_GREENGLADE_MART_CLERK },
        ...
        { MAP_GROUP(NEWHOPE_CITY_MART),   MAP_NUM(NEWHOPE_CITY_MART),   LOCALID_NEWHOPE_MART_CLERK },
