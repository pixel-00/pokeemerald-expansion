...
{
    [MAPSEC_TINYBUD_TOWN] = {MAP_GROUP(TINYBUD_TOWN), MAP_NUM(TINYBUD_TOWN), HEAL_LOCATION_TINYBUD_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_GREENGLADE_TOWN] = {MAP_GROUP(GREENGLADE_TOWN), MAP_NUM(GREENGLADE_TOWN), HEAL_LOCATION_GREENGLADE_TOWN},
    ...
    [MAPSEC_NEWHOPE_CITY] = {MAP_GROUP(NEWHOPE_CITY), MAP_NUM(NEWHOPE_CITY), HEAL_LOCATION_NEWHOPE_CITY},
    ...
    [MAPSEC_LUSH_CLEARING] = {MAP_GROUP(LUSH_CLEARING), MAP_NUM(LUSH_CLEARING), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_TINYBUD_TOWN:
        return FlagGet(FLAG_VISITED_TINYBUD_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GREENGLADE_TOWN:
        return FlagGet(FLAG_VISITED_GREENGLADE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_NEWHOPE_CITY:
        return FlagGet(FLAG_VISITED_NEWHOPE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_TINYBUD_TOWN;
    for (mapSecId = MAPSEC_TINYBUD_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_TINYBUD_TOWN:
                    SetWarpDestinationToHealLocation(HEAL_LOCATION_TINYBUD_TOWN_BRENDANS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
