...
{
    [HEAL_LOCATION_TINYBUD_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(TINYBUD_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(TINYBUD_TOWN_BRENDANS_HOUSE_2F), 3, 10},
    ...
    [HEAL_LOCATION_NEWHOPE_CITY - 1] = {MAP_GROUP(NEWHOPE_CITY), MAP_NUM(NEWHOPE_CITY), 16, 39},
    ...
    [HEAL_LOCATION_TINYBUD_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(TINYBUD_TOWN), MAP_NUM(TINYBUD_TOWN), 9, 7},
    [HEAL_LOCATION_GREENGLADE_TOWN - 1] = {MAP_GROUP(GREENGLADE_TOWN), MAP_NUM(GREENGLADE_TOWN), 18, 29},
